...
PROMPT='
%{$fg_bold[cyan]%} λ [ %{$fg_bold[white]%}%n%{$reset_color%}%{$fg_bold[cyan]%} ⚡ %{$reset_color%}%{$fg[gray]%}%M%{$reset_color%}%{$fg_bold[cyan]%} ]%{$fg[white]%} %{$fg[cyan]%}⚓ %{$reset_color%}%{$fg_bold[white]%}%~%{$reset_color%}%{$fg_bold[cyan]%} ✍ %{$reset_color%}%{$fg[gray]%}`jobs -s | wc -l | sed -e "s/ //g"`%{$reset_color%}%{$fg_bold[cyan]%}  ☄ %{$reset_color%}%{$fg[gray]%}`fc -ln -1`%{$reset_color%}%{$fg[cyan]%} $(git_prompt_info)
%{$reset_color%}'
